...
در وضعیت فعلیِ پیش‌انتشار، همهٔ مسیرهای برنامه و پنل مدیریت باز هستند تا مالک پروژه بتواند کامل بررسی کند. پیش از انتشار عمومی باید احراز هویت پزشک، نقش Admin و محدودسازی مسیرها فعال شوند.
